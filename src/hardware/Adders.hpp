...
namespace Hardware::Adders
{
    ...
    inline               Bus16 _add16(Bus16 a, Bus16 b);
    inline               Bus16 _inc16(Bus16 in);
...
namespace Hardware::Adders
{
    ...
    inline Bus16 _add16(Bus16 a, Bus16 b)
    {
        ...
        auto [sum15, carryOF] = _full_adder(  a &    0x8000u,  b &    0x8000u,  carry14  );
    ...
    inline Bus16 _inc16(Bus16 in)
    {
        ...
        auto [sum15, carryOF] = _half_adder(  in &    0x8000u,  carry14  );
